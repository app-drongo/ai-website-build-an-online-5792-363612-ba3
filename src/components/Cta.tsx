...
import { ArrowRight, Sparkles, Users, Gem, Shield } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "2K+", label: "Happy Customers", icon: Users },
    { value: "100%", label: "Handcrafted", icon: Gem },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of women who wear unique, handcrafted jewelry that tells their story. 
                Each piece is lovingly created by skilled artisans just for you.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Every piece backed by our craftsmanship guarantee
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Create your unique piece with our master artisans
              </p>
            </div>
          </div>
        </div>
