...
// Generated: 2025-09-14T04:16:03.545Z
...
export default function Navigation() {
  ...
  const navigation = [
    { name: "Home", href: "/" },
    { name: "Product Catalog", href: "/shop" },
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                <Gem className="size-4 text-background" />
              </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button size="sm" className="group bg-primary hover:bg-primary/90 text-background">
              Shop Now
              <ShoppingBag className="ml-2 size-4 transition-transform group-hover:scale-110" />
            </Button>
          </div>
