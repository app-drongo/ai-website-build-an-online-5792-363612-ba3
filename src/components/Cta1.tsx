...
import { ArrowRight, Heart, Award, Gem, Star } from "lucide-react"
...
export default function Cta1() {
  const stats = [
    ...
    { value: "5.0", label: "Customer Rating", icon: Star }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Experience the artistry and passion behind every handcrafted piece. 
                Let us create something uniquely beautiful just for you.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in leading fashion magazines
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Lifetime Care</h3>
              <p className="text-sm text-muted-foreground">
                Free cleaning and maintenance for all pieces
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Authenticity Guaranteed</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Custom Creations</h3>
              <p className="text-sm text-muted-foreground">
                Personalized designs crafted to your vision
              </p>
            </div>
          </div>
        </div>
