      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-8 sm:py-12">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
            ...
            <ChevronRight className="size-4" />
            <span className="text-foreground font-medium">Handcrafted Jewelry</span>
          </nav>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                From delicate necklaces to statement rings, each piece tells a unique story of artisan craftsmanship.
              </p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">48</span> Unique Pieces Available
              </span>
            </div>
            <div className="text-sm text-muted-foreground">
              <span className="font-semibold text-foreground">$85-$650</span> price range
            </div>
            <div className="text-sm text-muted-foreground">
